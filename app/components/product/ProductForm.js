export default function ProductForm({productForm, submitAction, setProductForm, loading}) {
    ...
    return (
        <div className="card">
            <form onSubmit={submitAction} className="relative items-center">
                <div className="mb-2">
                ...
                <div className="mt-4">
                    <button type="submit" className={loading ? 'btn-primary opacity-50' : 'btn-primary '}>
                        {loading ?
                            ...
                            <span>
                                {productForm?._id ? 'Update Product' : 'Save Product'}
                            </span>
                        }
                    </button>
                </div>
